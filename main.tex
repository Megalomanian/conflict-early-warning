...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/photo_zhu.png}}]{Linli Zhu}
received the B.S. degree in computer science from Ningxia University, Yinchuan, China, where she is currently pursuing the M.S. degree. Her research interests include natural language processing, social media mining, and computational social science.
\end{IEEEbiography}

\begin{IEEEbiography}{Ziqiang Ma}
received the Ph.D. degree from Ningxia University, Yinchuan, China. He is currently a faculty member at the School of Information Engineering, Ningxia University. His research interests include data mining, machine learning, and social network analysis.
\end{IEEEbiography}
