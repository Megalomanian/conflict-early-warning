...
On held-out Zhihu periods, the selected classifier achieves AUC $0.897$ with a significant recall gain over persistence, and---unlike exact-value regression---generalizes to entirely unseen topics (5-fold topic-held-out F1 $0.787\pm0.020$ vs.\ persistence $0.705$). The pipeline also transfers to 20 Weibo reversal events (AUC $0.989$). Threshold and feature ablations show that causal state history drives the gain, while exact-value regression remains persistence-dominated.
