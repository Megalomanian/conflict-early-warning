...
\end{tabular}
\begin{tablenotes}
\item All results under strict temporal ordering with train-only normalization. Weibo data: 6,407 windows from 27 reversal events. Zhihu data: 2,373 windows from 20 topics.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\columnwidth]{figures/fig_training_curves.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\columnwidth]{figures/fig_ablation.pdf}
\caption{Ablation study: R\textsuperscript{2} and Escalation F1 under increasing noise.}\label{fig:ablation}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.88\columnwidth]{figures/fig_component_ablation.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\columnwidth]{figures/fig_lead_time.pdf}
